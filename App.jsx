...
const App = () => {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen font-sans">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <svg className="w-6 h-6 mr-3 mt-1 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  ...
                  <form 
                    action="https://formspree.io/f/xyzjedrz"  
                    method="POST"
                    className="space-y-4"
                  >
                    <div>
                    ...
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white font-semibold py-2 px-4 rounded-md transition-colors duration-300 transform hover:scale-105"
                    >
                      Send Message
                    </button>
                  </form>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-400 text-sm">
              <p>&copy; {new Date().getFullYear()} Reymars Photography. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
      ...
      <a 
        href="https://wa.me/17865648544"  
        target="_blank" 
        rel="noopener noreferrer"
        className="fixed right-6 bottom-6 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-colors duration-300 z-50 animate-bounce hover:animate-none"
      >
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path d="M17.499 1.999a8.5 8.5 0 00-5.5 1.999A8.5 8.5 0 005.499 10.5a.5.5 0 00.125.313L4 20.5l9.812-5.188a.5.5 0 00.313-.125 8.5 8.5 0 005.375-7.998zm-5.5 13.5a6.5 6.5 0 01-3.25-.813l-.438-.25-3.062.75.812-3-.313-.438a6.5 6.5 0 019.938-7.562 6.5 6.5 0 01-2.499 12.001z"></path>
        </svg>
      </a>
