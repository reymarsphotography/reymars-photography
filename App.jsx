// NO USAMOS: import React, { useState, useEffect } from 'react';
// React y useState ya están disponibles globalmente gracias a los scripts en index.html

const App = () => {
  // Desestructuramos useState y useEffect del objeto global React
  ...
  const openLightbox = (image) => {
    // Usamos rutas relativas para asegurar que funcionen con Live Server
